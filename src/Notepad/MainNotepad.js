...
import NotepadApp from '../Component/Notepad';
...
const Notepad = () => {
  ...
  const [activeComponent, setActiveComponent] = useState("Notepad");
    ...
    <>
      <div>
        ...
        <div className="d-flex">
          ...
          {activeComponent === 'Notepad' && <NotepadApp colClass={mainDashboardColClass} />}
        </div>
      </div>
