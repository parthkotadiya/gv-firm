...
import CloseCase from '../Component/CloseCase'
...
const AllClosecase = () => {
  ...
  const [activeComponent, setActiveComponent] = useState("AllCloseCase");
    ...
    <>
      <div>
        ...
        <div className="d-flex">
          ...
          {activeComponent === 'AllCloseCase' && <CloseCase colClass={mainDashboardColClass} />}
        </div>
      </div>
